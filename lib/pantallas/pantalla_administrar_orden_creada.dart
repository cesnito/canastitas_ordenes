              ...
              try {
                ...
                api.editarPedido(
                  ...
                  onSuccess: (response) {
                    ...
                    ScaffoldMessenger.of(dialogContext).showSnackBar(
                      const SnackBar(content: Text("Orden editada con éxito")),
                    );
                    cart.clearCart();
                ...
                try {
                  ...
                  api.actualizaEstatusOrden(
                    ...
                    onSuccess: (response) {
                      ...
                      ScaffoldMessenger.of(dialogContext).showSnackBar(
                        const SnackBar(
                          content: Text("Orden cancelada con éxito"),
                        ),
                      );
                      cart.clearCart();
                      _customerNameController.clear();
          ...
          BotonCanastitasRetardo(
            ...
            onLongPressConfirmed: () {
              ...
              if (cart.cartItems.isEmpty) {
                ScaffoldMessenger.of(dialogContext).showSnackBar(
                  const SnackBar(
                    content: Text("No puedes entregar con carrito vacío"),
                  ),
                );
                return;
              }
              ...
              try {
                ...
                final ordenData = {'idOrden': idOrden, 'estatus': 3};
                ...
                api.actualizaEstatusOrden(
                  ...
                  onSuccess: (response) {
                    ...
                    ScaffoldMessenger.of(dialogContext).showSnackBar(
                      const SnackBar(
                        content: Text("Orden entregada con éxito"),
                      ),
                    );
                    cart.clearCart();
                    _customerNameController.clear();
